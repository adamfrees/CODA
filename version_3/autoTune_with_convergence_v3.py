...
def l1ErrorPlot(filename,target):
    data = regularize(filename,15,[4,5,6],leastSquares=True)
...
parentFolder = '/home/frees/Dropbox/_UW/CODA/version3/Autotune/attempt_6'
