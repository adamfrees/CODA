...
from regularize_w_cvx import regularize
import os
...
def l1ErrorPlot(filename,target):
    ...
    data.constructModel()
    data.compressedSense(alphaRange=[1.e-3,100000.],numSamples=5000)
...
parentFolder = '/home/frees/Dropbox/_UW/CODA/version3/Autotune/attempt_3'
